            ...
            <div
              ...
              style={{
                ...
                borderLeft: mentioned
                  ? "3px solid hsl(var(--brand-foreground))"
                  : "none",
              }}
            >
              <div
              ...
              >
                ...
                >
                  <MessageProfilePicture
                    ...
                    email={item.email}
                  />
                  <div className="flex flex-row text-center gap-x-1  max-w-fit ">
                    <p
                      className={`text-[15px] font-[500] ${
                        !allowSelectName ? "select-none" : ""
                      }`}
                    >
                      {item.username || item.email}
                    </p>
                    <p
                      className={`text-[13px] font-[300] opacity-50 ${
                        !allowSelectName ? "select-none" : ""
                      }`}
                    >
                ...
                <div
                  ...
                  style={{
                    ...
                    paddingLeft: "37px",
                    userSelect: allowSelectMessage ? "auto" : "none",
                  }}
                >
                  {item.content}
